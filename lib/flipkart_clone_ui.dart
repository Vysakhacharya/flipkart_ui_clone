    ...
    return Container(
      ...
      child: GridView.count(
        ...
        children: [
          ...
          MenuStripeItems(
            imageUrl: 'home',
            iteamLabel: 'Home&Furniture',
          ),
          MenuStripeItems(
            imageUrl: 'applience',
            iteamLabel: 'Applience',
          ),
          MenuStripeItems(
            imageUrl: 'travvel',
            iteamLabel: 'Travel',
          ...
          MenuStripeItems(
            imageUrl: 'beauty,toys&more',
            iteamLabel: 'Beauty,Toys & More',
          ),
          MenuStripeItems(
            imageUrl: 'twowheels',
            iteamLabel: 'Two Wheelrs',
          ),
        ],
      ),
    );
...
class MenuStripeItems extends StatelessWidget {
  final String? imageUrl;
  final String? iteamLabel;

  const MenuStripeItems({Key? key, this.imageUrl, this.iteamLabel})
      : super(key: key);
    ...
    return Column(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/${imageUrl ?? 'images/topoffers'}.png"),
            ),
          ),
        ),
        Text(
